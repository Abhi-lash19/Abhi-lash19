...
Currently working at **AbsoluteLabs**, designing AWS-native integrations and distributed pipelines powering real-world commerce and enterprise workflows.

---

## 🚀 About Me

I design and build **event-driven backend systems** using AWS services like Lambda, API Gateway, SQS, SNS, S3, and DynamoDB.
...
Previously worked as an **SRE Intern at Arcesium**, focusing on Kubernetes debugging, monitoring systems, and infrastructure automation.
